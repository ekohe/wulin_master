...
Sets color theme for a specific grid. The default color theme comes from  `app_config.yml` under the `config` folder. WulinMaster supports all [colors](https://materializecss.com/color.html) provided by [MaterializeCSS](https://materializecss.com/)

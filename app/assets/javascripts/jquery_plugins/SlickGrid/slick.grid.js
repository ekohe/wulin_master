...
(function($) {
  ...
  function SlickGrid(container, data, columns, options) {
    ...
    function getMaxSupportedCssHeight() {
      ...
      var testUpTo = (navigator.userAgent.toLowerCase().indexOf('firefox') > -1) ? 6000000 : 1000000000;
    ...
    function handleKeyDown(e) {
      ...
      if (handled) {
        ...
        // ignore exceptions - setting the original event's keycode throws access denied exception for "Ctrl" (hitting control key only, nothing else), "Shift" (maybe others)
        } catch (error) {}
      }
    }
    ...
    function makeActiveCellNormal() {
      ...
      if (activeCellNode) {
        ...
        if (d) {
          ...
          activeCellNode.innerHTML = getFormatter(activeRow, column)(activeRow, activeCell, getDataItemValueForColumn(d, column), column, d);
    ...
    function getRowByRecordId(id) {
      ...
      for (var i in data) {
        if (data.hasOwnProperty(i) && i !== 'length' && data[i] && data[i].id == id) {
          return {
            row: getRowAt(i),
            index: i
          };

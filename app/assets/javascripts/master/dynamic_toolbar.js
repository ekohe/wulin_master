(function($) {
  ...
  function DynamicToolbar() {
    ...
    function reset(gridName, initial) {
      var $headers;
      if(!gridName) {
        $headers = $(".grid-header");
      } else {
    ...
    function findEageItemsOnLeft($toolbar_wrapper, $toolbar){
    ...
    function findEageItemsOnRight($toolbar_wrapper, $toolbar){
      var visibleItemWidth;
      var invisibleItemWidth;
    ...
    $(document).on('click', '.grid-header .tb_prev', function(){
      var $prev = $(this);
    ...
    $(document).on('click', '.grid-header .tb_next', function(){
      var $next = $(this);
      var $toolbar_wrapper = $(this).siblings(".toolbar-wrapper");
      var $toolbar = $toolbar_wrapper.find(".toolbar");
  ...
  $.extend(true, window, {DynamicToolbar: DynamicToolbar});
})(jQuery);

WulinMaster.dynamicToolbar = new DynamicToolbar();

// Resize window
$(window).resize(function(e){
  if(e.target == window) {
    WulinMaster.dynamicToolbar.reset(null, false);
  } else {
    $(e.target).find(".grid_container").each(function(){
      var gridName = $(this).attr("name");
      WulinMaster.dynamicToolbar.reset(gridName, false);
    });
  }
});

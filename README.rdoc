...
5. Assume generator a new grid called *grid_test*, run the generator:
   ...
   This will create:
    ...
    create  app/<asset_folder_name>/controllers/grid_tests_controller.rb
    create  app/<asset_folder_name>/screens/grid_test_screen.rb
    create  app/<asset_folder_name>/grids/grid_test_grid.rb
    create  app/<asset_folder_name>/models/grid_test.rb
    create  app/<asset_folder_name>/views/grid_tests
   ...
   You can configurate *<asset_folder_name>* in *config/initializers/wulin_master.rb*
